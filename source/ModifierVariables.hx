...
class ModifierVariables
{
    ...
    public static function modifierSetup():Void
    {
        ModifierState.modifierList = [
			...
			{name: 'Botplay', value: false, conflicts: [0,2,3,4,5,6,7,9,10,11,33,34], multi: 0, realmulti: 0, equation: 'times', abs: false,  revAtLow: false, type: 'switch', minValue: 0, maxValue: 0, curValue: 0, offAt: 0, addChange: 0, string: '', explanation: "Feeling lazy or have a skill issue? Activate Botplay mode to let a perfect bot play through the song for you. Sets score rate all the way to 0. Can be switched on or off."},
			...
			{name: 'Play Opponent Side', value: false, conflicts: [], multi: 0.2, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'switch', minValue: 0, maxValue: 0, curValue: 0, offAt: 0, addChange: 0, string: '\nOPPONENT PLAY', explanation: "Want to see how it feels to play as the opponent? Take on the challenge of playing from the opposite perspective. Can be switched on or off. This option does not affect the score rate or any other gameplay mechanics."}
		];
