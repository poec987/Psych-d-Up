...
class ModifierVariables
{
    ...
    public static function modifierSetup():Void
    {
        ModifierState.modifierList = [
			...
			{name: 'Botplay', value: false, conflicts: [0,2,3,4,5,6,7,9,10,11,33,34], multi: 0, realmulti: 0, equation: 'times', abs: false,  revAtLow: false, type: 'switch', minValue: 0, maxValue: 0, curValue: 0, offAt: 0, addChange: 0, string: '', explanation: "Feeling lazy or struggling to hit those notes? Let a perfect bot play the song for you and observe its flawless performance. Sets score rate all the way to 0. Can be switched on or off."},
			...
			{name: 'Play Opponent Side', value: false, conflicts: [], multi: 0, realmulti: 0, equation: '', abs: false,  revAtLow: false, type: 'switch', minValue: 0, maxValue: 0, curValue: 0, offAt: 0, addChange: 0, string: '\nOPPONENT PLAY', explanation: "Want to switch things up? Play the song from the opponent's perspective! Can be switched on or off. This option does not affect the score rate or any other gameplay mechanics."}
		];
