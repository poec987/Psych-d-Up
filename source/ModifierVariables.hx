...
class ModifierVariables
{
    ...
    public static function updateModifiers():Void
    {
        _modifiers = {
            ...
            SingleDigits: ModifierState.modifierList[1].value,

            Perfect: ModifierState.modifierList[2].value,

            ShittyEnding: ModifierState.modifierList[3].value,

            BadTrip: ModifierState.modifierList[4].value,

            TruePerfect: ModifierState.modifierList[5].value,

            Lives: ModifierState.modifierList[6].curValue,
            LivesSwitch: ModifierState.modifierList[6].value,

            Brightness: ModifierState.modifierList[7].curValue,
            BrightnessSwitch: ModifierState.modifierList[7].value,

            HPGain: ModifierState.modifierList[8].curValue,
            HPGainSwitch: ModifierState.modifierList[8].value,

            HPLoss: ModifierState.modifierList[9].curValue,
            HPLossSwitch: ModifierState.modifierList[9].value,

            StartHealth: ModifierState.modifierList[10].curValue,
            StartHealthSwitch: ModifierState.modifierList[10].value,

            Enigma: ModifierState.modifierList[11].value,

            Vibe: ModifierState.modifierList[12].curValue,
            VibeSwitch: ModifierState.modifierList[12].value,

            Offbeat: ModifierState.modifierList[13].curValue,
            OffbeatSwitch: ModifierState.modifierList[13].value,

            HitZones: ModifierState.modifierList[14].curValue,
            HitZonesSwitch: ModifierState.modifierList[14].value,

            NoteSpeed: ModifierState.modifierList[15].curValue,
            NoteSpeedSwitch: ModifierState.modifierList[15].value,

            InvisibleNotes: ModifierState.modifierList[16].value,

            SnakeNotes: ModifierState.modifierList[17].curValue,
            SnakeNotesSwitch: ModifierState.modifierList[17].value,

            DrunkNotes: ModifierState.modifierList[18].curValue,
            DrunkNotesSwitch: ModifierState.modifierList[18].value,

            AccelNotes: ModifierState.modifierList[19].curValue,
            AccelNotesSwitch: ModifierState.modifierList[19].value,

            Shortsighted: ModifierState.modifierList[20].curValue,
            ShortsightedSwitch: ModifierState.modifierList[20].value,

            Longsighted: ModifierState.modifierList[21].curValue,
            LongsightedSwitch: ModifierState.modifierList[21].value,

            FlippedNotes: ModifierState.modifierList[22].value,

            HyperNotes: ModifierState.modifierList[23].curValue,
            HyperNotesSwitch: ModifierState.modifierList[23].value,

            EelNotes: ModifierState.modifierList[24].curValue,
            EelNotesSwitch: ModifierState.modifierList[24].value,

            Stretch: ModifierState.modifierList[25].curValue,
            StretchSwitch: ModifierState.modifierList[25].value,

            Widen: ModifierState.modifierList[26].curValue,
            WidenSwitch: ModifierState.modifierList[26].value,

            Jacktastic: ModifierState.modifierList[27].curValue,
            JacktasticSwitch: ModifierState.modifierList[27].value,

            Seasick: ModifierState.modifierList[28].curValue,
            SeasickSwitch: ModifierState.modifierList[28].value,

            UpsideDown: ModifierState.modifierList[29].value,

            Mirror: ModifierState.modifierList[30].value,

            Camera: ModifierState.modifierList[31].curValue,
            CameraSwitch: ModifierState.modifierList[31].value,

            Earthquake: ModifierState.modifierList[32].curValue,
            EarthquakeSwitch: ModifierState.modifierList[32].value,

            Love: ModifierState.modifierList[33].curValue,
            LoveSwitch: ModifierState.modifierList[33].value,

            Fright: ModifierState.modifierList[34].curValue,
            FrightSwitch: ModifierState.modifierList[34].value,

            MustDie: ModifierState.modifierList[35].curValue,
            MustDieSwitch: ModifierState.modifierList[35].value,

            Freeze: ModifierState.modifierList[36].curValue,
            FreezeSwitch: ModifierState.modifierList[36].value,

            Paparazzi: ModifierState.modifierList[37].curValue,
            PaparazziSwitch: ModifierState.modifierList[37].value
        };
    }
    ...
    public static function replaceValues():Void
    {
        ...
        ModifierState.modifierList[1].value = _modifiers.SingleDigits;

        ModifierState.modifierList[2].value = _modifiers.Perfect;

        ModifierState.modifierList[3].value = _modifiers.ShittyEnding;

        ModifierState.modifierList[4].value = _modifiers.BadTrip;

        ModifierState.modifierList[5].value = _modifiers.TruePerfect;

        ModifierState.modifierList[6].curValue = _modifiers.Lives;
        ModifierState.modifierList[6].value = _modifiers.LivesSwitch;

        ModifierState.modifierList[7].curValue = _modifiers.Brightness;
        ModifierState.modifierList[7].value = _modifiers.BrightnessSwitch;

        ModifierState.modifierList[8].curValue = _modifiers.HPGain;
        ModifierState.modifierList[8].value = _modifiers.HPGainSwitch;

        ModifierState.modifierList[9].curValue = _modifiers.HPLoss;
        ModifierState.modifierList[9].value = _modifiers.HPLossSwitch;

        ModifierState.modifierList[10].curValue = _modifiers.StartHealth;
        ModifierState.modifierList[10].value = _modifiers.StartHealthSwitch;
        
        ModifierState.modifierList[11].value = _modifiers.Enigma;

        ModifierState.modifierList[12].curValue = _modifiers.Vibe;
        ModifierState.modifierList[12].value = _modifiers.VibeSwitch;

        ModifierState.modifierList[13].curValue = _modifiers.Offbeat;
        ModifierState.modifierList[13].value = _modifiers.OffbeatSwitch;

        ModifierState.modifierList[14].curValue = _modifiers.HitZones;
        ModifierState.modifierList[14].value = _modifiers.HitZonesSwitch;

        ModifierState.modifierList[15].curValue = _modifiers.NoteSpeed;
        ModifierState.modifierList[15].value = _modifiers.NoteSpeedSwitch;

        ModifierState.modifierList[16].value = _modifiers.InvisibleNotes;

        ModifierState.modifierList[17].curValue = _modifiers.SnakeNotes;
        ModifierState.modifierList[17].value = _modifiers.SnakeNotesSwitch;

        ModifierState.modifierList[18].curValue = _modifiers.DrunkNotes;
        ModifierState.modifierList[18].value = _modifiers.DrunkNotesSwitch;

        ModifierState.modifierList[19].curValue = _modifiers.AccelNotes;
        ModifierState.modifierList[19].value = _modifiers.AccelNotesSwitch;

        ModifierState.modifierList[20].curValue = _modifiers.Shortsighted;
        ModifierState.modifierList[20].value = _modifiers.ShortsightedSwitch;

        ModifierState.modifierList[21].curValue = _modifiers.Longsighted;
        ModifierState.modifierList[21].value = _modifiers.LongsightedSwitch;

        ModifierState.modifierList[22].value = _modifiers.FlippedNotes;

        ModifierState.modifierList[23].curValue = _modifiers.HyperNotes;
        ModifierState.modifierList[23].value = _modifiers.HyperNotesSwitch;

        ModifierState.modifierList[24].curValue = _modifiers.EelNotes;
        ModifierState.modifierList[24].value = _modifiers.EelNotesSwitch;

        ModifierState.modifierList[25].curValue = _modifiers.Stretch;
        ModifierState.modifierList[25].value = _modifiers.StretchSwitch;

        ModifierState.modifierList[26].curValue = _modifiers.Widen;
        ModifierState.modifierList[26].value = _modifiers.WidenSwitch;

        ModifierState.modifierList[27].curValue = _modifiers.Jacktastic;
        ModifierState.modifierList[27].value = _modifiers.JacktasticSwitch;

        ModifierState.modifierList[28].curValue = _modifiers.Seasick;
        ModifierState.modifierList[28].value = _modifiers.SeasickSwitch;

        ModifierState.modifierList[29].value = _modifiers.UpsideDown;

        ModifierState.modifierList[30].value = _modifiers.Mirror;

        ModifierState.modifierList[31].curValue = _modifiers.Camera;
        ModifierState.modifierList[31].value = _modifiers.CameraSwitch;

        ModifierState.modifierList[32].curValue = _modifiers.Earthquake;
        ModifierState.modifierList[32].value = _modifiers.EarthquakeSwitch;

        ModifierState.modifierList[33].curValue = _modifiers.Love;
        ModifierState.modifierList[33].value = _modifiers.LoveSwitch;

        ModifierState.modifierList[34].curValue = _modifiers.Fright;
        ModifierState.modifierList[34].value = _modifiers.FrightSwitch;

        ModifierState.modifierList[35].curValue = _modifiers.MustDie;
        ModifierState.modifierList[35].value = _modifiers.MustDieSwitch;

        ModifierState.modifierList[36].curValue = _modifiers.Freeze;
        ModifierState.modifierList[36].value = _modifiers.FreezeSwitch;

        ModifierState.modifierList[37].curValue = _modifiers.Paparazzi;
        ModifierState.modifierList[37].value = _modifiers.PaparazziSwitch;
    }
