        ...
        menuItems.forEach(function(spr:FlxSprite)
            {
                if (!goingBack)
                {
                    ...
                    spr.scale.set(FlxMath.lerp(spr.scale.x, 1, camLerp), FlxMath.lerp(spr.scale.y, 1, 0.4));
    
                    if (spr.ID == curSelected)
                        spr.scale.set(FlxMath.lerp(spr.scale.x, 1.5, camLerp), FlxMath.lerp(spr.scale.y, 1.5, 0.4));
                }
                else
                    spr.scale.set(FlxMath.lerp(spr.scale.x, 0, camLerp), FlxMath.lerp(spr.scale.y, 0, 0.4));
            });
    }
